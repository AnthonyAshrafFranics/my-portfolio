  ...
  return (
    <div className="bg-[#121121] pb-[3rem] pt-[4rem] md:pt-[8rem]" ref={aboutRef}>
      <div className="grid grid-cols-1 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] items-center">
        <div>
          <h1 className="text-[20px] font-bold uppercase text-[#23C79C] mb-[1rem]">
            ABOUT ME
          </h1>
          <h2 className="text-[25px] md:text-[35px] lg:text-[45px] md:leading-[3rem] leading-[2rem] capitalize mb-[3rem] font-bold text-white">
            Tranforming <span className="text-[#23C79C]">Visions</span>
          </h2>
          ...
          <Link href="https://drive.google.com/uc?export=download&id=14mIjwf7FG-91c0h2aVaQ-lqed4ci6Tj1" className="px-[2rem] hover:bg-[#7df3d3] transition-all rounded duration-200 py-[1rem] text-[18px] font-bold uppercase bg-[#23C79C] text-black flex items-center space-x-2 w-fit">
            Download CV{" "}
        ...
        <div className="lg:w-[500px] mx-auto md:mx-0 mt-[2rem] lg:mt-0 lg:h-[500px] w-[300px] h-[300px] relative">
            ...
            <div className="absolute w-[80%] h-[100%] z-[10] bg-[#23C79C] top-[-2rem] right-[-0.5rem]"></div>
        </div>
      </div>
    </div>
  );
